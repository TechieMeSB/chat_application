# Chat Application Using Tkinter GUI :iphone:
...
* Clients can also play game of guessing word. Client who initiats the game will type a word that gets encrypted which should be guessed & decrypt by other Clients in the game.
---
...
##### Clients connected to Server can initiate chat
<br>
<div>
  <img src="Output/2.png" width="800">
</div><br>
<div>
  <img src="Output/3.png" width="800">
</div><br>
<div>
  <img src="Output/4.png" width="800">
</div><br>
<div>
  <img src="Output/5.png" width="800">
</div><br>
